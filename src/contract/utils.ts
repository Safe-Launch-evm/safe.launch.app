...
export async function getPoolAddress(publicClient: PublicClient, tokenAddress: string): Promise<string> {
    const [tokenA, tokenB] = WRWA_ADDRESS.toLowerCase() < tokenAddress.toLowerCase()
